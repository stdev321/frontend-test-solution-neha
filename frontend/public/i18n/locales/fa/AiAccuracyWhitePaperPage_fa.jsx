...
function AiAccuracyWhitePaperPage() {
  ...
  const TITLE = "عنوان سفیدنامه دقت هوش مصنوعی";

  const SECTION1_TITLE = "بخش ۱: عنوان";
  const SECTION1_CONTENT = "محتوای بخش ۱";

  const SECTION2_TITLE = "بخش ۲: عنوان";
  const SECTION2_CONTENT_P1 = "مقدمه بخش ۲";
  const SECTION2_CONTENT_LIST = "{ عنوان: موفقیت‌های هوش مصنوعی, متن: متن موفقیت‌های هوش مصنوعی }, { عنوان: خطاهای هوش مصنوعی, متن: متن خطاهای هوش مصنوعی }, { عنوان: مقایسه هوش مصنوعی با انسان, متن: متن مقایسه هوش مصنوعی با انسان }";

  const SECTION3_TITLE = "بخش ۳: عنوان";
  const SECTION3_CONTENT_P1 = "مقدمه بخش ۳";
  const SECTION3_CONTENT_LIST = "همدلی, بار اضافی, اعتماد";
  const SECTION3_CONTENT_P2 = "رویکرد ماینداسکریپت";

  const SECTION4_TITLE = "بخش ۴: عنوان";
  const SECTION4_CONTENT_LIST = "اطلاعات, محدودیت‌ها, تأیید, شخصیت‌ها";

  const SECTION5_TITLE = "بخش ۵: عنوان";
  const SECTION5_DISCLAIMER = "سلب مسئولیت";
  const SECTION5_EMERGENCY = "اورژانس";
