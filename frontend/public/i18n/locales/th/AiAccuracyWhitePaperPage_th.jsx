...
function AiAccuracyWhitePaperPage() {
  ...
  const TITLE = "1. หัวข้อเอกสารวิจัยเกี่ยวกับความแม่นยำของ AI";

  const SECTION1_TITLE = "2. หัวข้อบทที่ 1";
  const SECTION1_CONTENT = "3. เนื้อหาของบทที่ 1";

  const SECTION2_TITLE = "4. หัวข้อบทที่ 2";
  const SECTION2_CONTENT_P1 = "5. บทนำของบทที่ 2";
  const SECTION2_CONTENT_LIST = "6. [
    { 
      title: ความสำเร็จของ AI,
      text: ข้อความเกี่ยวกับความสำเร็จของ AI
    },
    {
      title: ข้อผิดพลาดของ AI,
      text: ข้อความเกี่ยวกับข้อผิดพลาดของ AI
    },
    {
      title: เปรียบเทียบ AI กับมนุษย์,
      text: ข้อความเกี่ยวกับการเปรียบเทียบ AI กับมนุษย์
    }
  ]";

  const SECTION3_TITLE = "7. หัวข้อบทที่ 3";
  const SECTION3_CONTENT_P1 = "8. บทนำของบทที่ 3";
  const SECTION3_CONTENT_LIST = "9. [
    ความท้าทายเรื่องความเห็นอกเห็นใจ,
    ความท้าทายเรื่องภาระงานมากเกินไป,
    ความท้าทายเรื่องความมั่นใจ
  ]";
  const SECTION3_CONTENT_P2 = "10. แนวทางของ VirtualMD";

  const SECTION4_TITLE = "11. หัวข้อบทที่ 4";
  const SECTION4_CONTENT_LIST = "12. [
    แนวทางเกี่ยวกับข้อมูล,
    แนวทางเกี่ยวกับข้อจำกัด,
    แนวทางเกี่ยวกับการตรวจสอบ,
    แนวทางเกี่ยวกับบุคคล
  ]";

  const SECTION5_TITLE = "13. หัวข้อบทที่ 5";
  const SECTION5_DISCLAIMER = "14. คำชี้แจง";
  const SECTION5_EMERGENCY = "15. กรณีฉุกเฉิน";
