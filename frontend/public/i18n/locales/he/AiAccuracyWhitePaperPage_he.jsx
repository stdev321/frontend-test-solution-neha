...
function AiAccuracyWhitePaperPage() {
  ...
  const TITLE = "1. נייר עמדה על דיוק הבינה המלאכותית";

  const SECTION1_TITLE = "2. פרק 1: הקדמה";
  const SECTION1_CONTENT = "3. בפרק זה נסקור את היסודות של דיוק בבינה מלאכותית ואיך הוא משפיע על התוצאות הסופיות.";

  const SECTION2_TITLE = "4. פרק 2: תוצאות ואתגרים";
  const SECTION2_CONTENT_P1 = "5. במבוא לפרק זה נדון בהצלחות ובקשיים שחווים בעת שימוש בבינה מלאכותית.";
  const SECTION2_CONTENT_LIST = "6. { title: 'הצלחות הבינה המלאכותית', text: 'בפסקה זו נבחן מקרים בהם הבינה המלאכותית הובילה לתוצאות מרשימות וחדשניות.' }, { title: 'טעויות הבינה המלאכותית', text: 'כאן נעסוק בדוגמאות לטעויות שנפלו בעת שימוש בבינה מלאכותית והשפעתן.' }, { title: 'השוואה בין בינה מלאכותית לאנושית', text: 'נדון ביתרונות ובחסרונות של שימוש בבינה מלאכותית בהשוואה לביצועים אנושיים.' }";

  const SECTION3_TITLE = "7. פרק 3: אסטרטגיות ופתרונות";
  const SECTION3_CONTENT_P1 = "8. בפרק זה נתמקד באסטרטגיות שונות להתמודדות עם אתגרי הבינה המלאכותית.";
  const SECTION3_CONTENT_LIST = "9. 'התמודדות עם אתגרי האמפתיה', 'התמודדות עם עומס מידע', 'בניית ביטחון בשימוש בבינה מלאכותית'";
  const SECTION3_CONTENT_P2 = "10. הגישה של מיינדסקריפט";

  const SECTION4_TITLE = "11. פרק 4: הנחיות ומדיניות";
  const SECTION4_CONTENT_LIST = "12. 'הנחיות לניהול מידע', 'הגבלות ואתגרים', 'אימות ובדיקת נתונים', 'פיתוח פרסונות לבינה מלאכותית'";

  const SECTION5_TITLE = "13. פרק 5: הצהרות והבהרות";
  const SECTION5_DISCLAIMER = "14. הצהרת פטור מאחריות";
  const SECTION5_EMERGENCY = "15. התייחסות למצבי חירום";
