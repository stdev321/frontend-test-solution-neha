...
function AiAccuracyWhitePaperPage() {
  ...
  const TITLE = "t('aiAccuracyWhitepaper.title')";

  const SECTION1_TITLE = "t('aiAccuracyWhitepaper.section1.title')";
  const SECTION1_CONTENT = "t('aiAccuracyWhitepaper.section1.content')";

  const SECTION2_TITLE = "t('aiAccuracyWhitepaper.section2.title')";
  const SECTION2_CONTENT_P1 = "t('aiAccuracyWhitepaper.section2.intro')";
  const SECTION2_CONTENT_LIST = "[
    { 
      title: t('aiAccuracyWhitepaper.section2.aiSuccess.title'),
      text: t('aiAccuracyWhitepaper.section2.aiSuccess.text')
    },
    {
      title: t('aiAccuracyWhitepaper.section2.aiErrors.title'),
      text: t('aiAccuracyWhitepaper.section2.aiErrors.text')
    },
    {
      title: t('aiAccuracyWhitepaper.section2.aiVsHuman.title'),
      text: t('aiAccuracyWhitepaper.section2.aiVsHuman.text')
    }
  ]";

  const SECTION3_TITLE = "t('aiAccuracyWhitepaper.section3.title')";
  const SECTION3_CONTENT_P1 = "t('aiAccuracyWhitepaper.section3.intro')";
  const SECTION3_CONTENT_LIST = "[
    t('aiAccuracyWhitepaper.section3.challenges.empathy'),
    t('aiAccuracyWhitepaper.section3.challenges.overload'),
    t('aiAccuracyWhitepaper.section3.challenges.confidence')
  ]";
  const SECTION3_CONTENT_P2 = "t('aiAccuracyWhitepaper.section3.VirtualMDApproach')";

  const SECTION4_TITLE = "t('aiAccuracyWhitepaper.section4.title')";
  const SECTION4_CONTENT_LIST = "[
    t('aiAccuracyWhitepaper.section4.guidelines.information'),
    t('aiAccuracyWhitepaper.section4.guidelines.limitations'),
    t('aiAccuracyWhitepaper.section4.guidelines.verify'),
    t('aiAccuracyWhitepaper.section4.guidelines.personas')
  ]";

  const SECTION5_TITLE = "t('aiAccuracyWhitepaper.section5.title')";
  const SECTION5_DISCLAIMER = "t('aiAccuracyWhitepaper.section5.disclaimer')";
  const SECTION5_EMERGENCY = "t('aiAccuracyWhitepaper.section5.emergency')";
