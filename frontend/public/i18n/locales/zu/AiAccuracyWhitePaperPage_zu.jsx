...
function AiAccuracyWhitePaperPage() {
  ...
  const TITLE = "1. Isihloko se-Accuracy Whitepaper";

  const SECTION1_TITLE = "2. Isigaba 1: Isingeniso";
  const SECTION1_CONTENT = "3. Leli phepha limhlophe libheka ukunemba kwezinhlelo ze-AI, libheka izindlela ezahlukene zokuhlola nokuthuthukisa ukunemba kwazo.";

  const SECTION2_TITLE = "4. Isigaba 2: Izibonelo Zempumelelo Nezinkinga";
  const SECTION2_CONTENT_P1 = "5. Lapha sibheka izibonelo ezithile zokuthi i-AI ibilunge kanjani nokuthi yaphi.";
  const SECTION2_CONTENT_LIST = "6. [
    { 
      title: 'Izibonelo Zempumelelo ye-AI',
      text: 'Kulesi sigaba, sizohlola izimo lapho i-AI ikhombise khona ukusebenza kahle okumangalisayo.'
    },
    {
      title: 'Izinkinga Ze-AI',
      text: 'Siphinde sibheke izimo lapho i-AI yehluleka khona nokuthi kungani lokho kwenzeka.'
    },
    {
      title: 'I-AI Uma Iqhathaniswa Nabantu',
      text: 'Sihlola ukuthi i-AI iqhathaniswa kanjani nabantu emisebenzini ethile yokucabanga.'
    }
  ]";

  const SECTION3_TITLE = "7. Isigaba 3: Izinselelo Nezixazululo";
  const SECTION3_CONTENT_P1 = "8. Kulesi sigaba, sibheka izinselelo ezithile ezibhekene ne-AI nokuthi singazixazulula kanjani.";
  const SECTION3_CONTENT_LIST = "9. [
    'Ukuzwelana',
    'Ukulayisha Ngokweqile',
    'Ukuzethemba'
  ]";
  const SECTION3_CONTENT_P2 = "10. Indlela ye-VirtualMD";

  const SECTION4_TITLE = "11. Isigaba 4: Imihlahlandlela Yokusebenzisa";
  const SECTION4_CONTENT_LIST = "12. [
    'Ulwazi Olubalulekile',
    'Imingcele Yobuchwepheshe',
    'Ukuqinisekisa Ulwazi',
    'Izithombe Zabalingiswa'
  ]";

  const SECTION5_TITLE = "13. Isigaba 5: Isaziso Esibalulekile";
  const SECTION5_DISCLAIMER = "14. Isaziso sokuzivikela";
  const SECTION5_EMERGENCY = "15. Izimo eziphuthumayo";
