...
function AiAccuracyWhitePaperPage() {
  ...
  const TITLE = "1. एआई शुद्धता श्वेतपत्रिका का शीर्षक";

  const SECTION1_TITLE = "2. एआई शुद्धता श्वेतपत्रिका का पहला खंड का शीर्षक";
  const SECTION1_CONTENT = "3. एआई शुद्धता श्वेतपत्रिका के पहले खंड की सामग्री";

  const SECTION2_TITLE = "4. एआई शुद्धता श्वेतपत्रिका का दूसरा खंड का शीर्षक";
  const SECTION2_CONTENT_P1 = "5. एआई शुद्धता श्वेतपत्रिका के दूसरे खंड का परिचय";
  const SECTION2_CONTENT_LIST = "6. {
    शीर्षक: एआई शुद्धता श्वेतपत्रिका के दूसरे खंड की एआई सफलता का शीर्षक,
    पाठ: एआई शुद्धता श्वेतपत्रिका के दूसरे खंड की एआई सफलता का पाठ
  },
  {
    शीर्षक: एआई शुद्धता श्वेतपत्रिका के दूसरे खंड की एआई त्रुटियों का शीर्षक,
    पाठ: एआई शुद्धता श्वेतपत्रिका के दूसरे खंड की एआई त्रुटियों का पाठ
  },
  {
    शीर्षक: एआई शुद्धता श्वेतपत्रिका के दूसरे खंड की एआई बनाम मानव का शीर्षक,
    पाठ: एआई शुद्धता श्वेतपत्रिका के दूसरे खंड की एआई बनाम मानव का पाठ
  }";

  const SECTION3_TITLE = "7. एआई शुद्धता श्वेतपत्रिका का तीसरा खंड का शीर्षक";
  const SECTION3_CONTENT_P1 = "8. एआई शुद्धता श्वेतपत्रिका के तीसरे खंड का परिचय";
  const SECTION3_CONTENT_LIST = "9. [
    एआई शुद्धता श्वेतपत्रिका के तीसरे खंड की चुनौतियाँ: सहानुभूति,
    एआई शुद्धता श्वेतपत्रिका के तीसरे खंड की चुनौतियाँ: अधिभार,
    एआई शुद्धता श्वेतपत्रिका के तीसरे खंड की चुनौतियाँ: विश्वास
  ]";
  const SECTION3_CONTENT_P2 = "10. एआई शुद्धता श्वेतपत्रिका के तीसरे खंड का माइंडस्क्रिप्ट दृष्टिकोण";

  const SECTION4_TITLE = "11. एआई शुद्धता श्वेतपत्रिका का चौथा खंड का शीर्षक";
  const SECTION4_CONTENT_LIST = "12. [
    एआई शुद्धता श्वेतपत्रिका के चौथे खंड के दिशानिर्देश: जानकारी,
    एआई शुद्धता श्वेतपत्रिका के चौथे खंड के दिशानिर्देश: सीमाएँ,
    एआई शुद्धता श्वेतपत्रिका के चौथे खंड के दिशानिर्देश: सत्यापन,
    एआई शुद्धता श्वेतपत्रिका के चौथे खंड के दिशानिर्देश: पर्सोनास
  ]";

  const SECTION5_TITLE = "13. एआई शुद्धता श्वेतपत्रिका का पांचवाँ खंड का शीर्षक";
  const SECTION5_DISCLAIMER = "14. एआई शुद्धता श्वेतपत्रिका के पांचवें खंड का अस्वीकरण";
  const SECTION5_EMERGENCY = "15. एआई शुद्धता श्वेतपत्रिका के पांचवें खंड की आपातकालीन स्थिति";
